...
class Image:
    ...
    skippers: List[str] = list()  # The number of times this image has been skipped
    taggers: Dict[str, Dict] = list()  # People who have tagged this image and their tags: taggers[user_id] = {'tag_id',
    # 'value'}
