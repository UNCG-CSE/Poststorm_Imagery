...
class Image:
    ...
    skip_count: int = 0  # The number of times this image has been skipped
    skippers: List[str]  # The number of times this image has been skipped

    tagged_times: int = 0  # The number of unique people that have tagged this image
    tags: Dict[str, Dict]  # The people who have tagged this image and their tags: tags[user_id] = {'tag_id', 'value'}
    ...
    def add_tag(self, user_id: str, tag: str, content: str):
        self.tags[user_id][tag] = content

    def remove_tag(self, user_id: str, tag: str):
        self.tags[user_id][tag] = None
