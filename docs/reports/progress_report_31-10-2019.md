...
For correlation and covariance, I calculated the correlation and covariance of image size and resolution. Then I ploted the data to see if their is any correlation between size and resolution. Found that their is very little position correlation between size and resolution.
